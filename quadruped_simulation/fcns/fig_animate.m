...
%% --- Restore legends for final export ---
legend(h_x, {'x','y','z','x_d','y_d','z_d'}, 'Location','eastoutside');
legend(h_dx, {'vx','vy','vz','vx_d','vy_d','vz_d'}, 'Location','eastoutside');
legend(h_w, {'wx','wy','wz','wx_d','wy_d','wz_d'}, 'Location','eastoutside');
legend(h_u, {'Fz_1','Fz_2','Fz_3','Fz_4','Fz1_d','Fz2_d','Fz3_d','Fz4_d'}, 'Location','eastoutside');
