...
[t,EA,EAd] = fig_plot(tout,Xout,Uout,Xdout,Udout,Uext,p);


% Mostra la figura corrente
figure(gcf);

% Imposta dimensioni corrette per la stampa
set(gcf, 'Units', 'Inches');
pos = get(gcf, 'Position');  % Ottieni dimensioni attuali della figura

% Adatta il formato di stampa al contenuto
set(gcf, 'PaperPositionMode', 'Auto', ...
         'PaperUnits', 'Inches', ...
         'PaperSize', [pos(3), pos(4)]);

% Salva la figura come PDF vettoriale (alta qualità, senza tagli)
print(gcf, '-dpdf', 'bound_massa_5.5_u_0.4_v_max2_noanimation.pdf');
% print(gcf, '-dpdf', 'bound_massa_5.5_u_1_v_max1.5.pdf');
